# Example docker file for a simple web server
# https://nodejs.org/en/docs/guides/nodejs-docker-webapp/

# official LTS image: https://hub.docker.com/r/library/ubuntu/
FROM node:16
...
# Please note that if you are using npm version 4 or earlier
...
# bitJudo has a good explanation of this here. 
# Furthermore, the npm ci command, specified in the comments, 
# helps provide faster, reliable, 
...
# using CMD which defines your runtime. 
